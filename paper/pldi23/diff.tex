...
%DIF ADD new.tex   Tue Mar 21 11:47:49 2023
...
%DIF < ----------------------------------------%
%DIF < 
%DIF < \subsection{Overall Structure}\label{sec:overall}
\DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < \begin{figure}
%DIFDELCMD <   \includegraphics[width=.9\textwidth]{img/overall}
%DIFDELCMD < \vspace*{-.5em}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Overall structure of $\tool$}}
  %DIFAUXCMD
%DIFDELCMD < \label{fig:overall}
%DIFDELCMD < \vspace*{-1em}
%DIFDELCMD < \end{figure}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \section{Implementation}\label{sec:impl}

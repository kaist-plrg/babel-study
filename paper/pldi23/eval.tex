...
synthesized tests increased \inred{2.55x (5,336 / 2,095)} from 0-FS to 1-FS and
\inred{15.7x (83,668 / 5,336)} from 1-FS to 2-FS.
%
...
%
The conformance tests synthesized with $1$-FS coverage detect \inred{15 (60 -
45)} more conformance bugs, and tests synthesized with $2$-FS coverage detect
\inred{55 (115 - 60)} more bugs.
